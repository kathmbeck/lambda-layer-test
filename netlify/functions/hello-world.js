export default async (req, context) => {
   ...
   console.log({
    "2222":"2222",
   "somaefoiahefaegfeJson":"log h3wifhefgy-log",
   "anotaflzdulaelhher":"log",
   "frogOvrarvaenA":"log",
   "boblaefafeaefaw":"lawblog",
   "blaaefarhkydhblah":"log",
   "soagrarhathdmykukmething":"lalalalala"
  })
  ...
  console.log("✨")
  console.log("efiahleuifhalweiufaliehflawuegfliawegfiluaegfiluagwefilugaelfiugaweiulfgaweiufgaiuwegfliuaegfiuaegw;fihaew;")
  console.log("felahufhhfaeluhaefhluaeflhuaefluhefauhlaeflhluhafehulaeflhfaeflahefhlaufahlueafehluflaehuafhluafehluafehluahlfuhluafehluafelhuafehlufaelhuafehluafehlafehluafhluafealefhuaeflhulhufaeaeflhualhfualfhuafhluaeflhulaefhaflhlaehuflahuefaeflhu")
  console.log("efiahleuifhalweiufaliehflawuegfliawegfiluaegfiluagwefilugaelfiugaweiulfgaweiufgaiuwegfliuaegfiuaegw;fihaew;")
